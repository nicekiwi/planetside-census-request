...
const planetside_census_data_1 = require("planetside-census-data");
...
function requestUrlComplete(namespace, serviceId) {
    return `${exports.requestUrlHttps}/s:${serviceId}/get/${namespace}:${planetside_census_data_1.NamespaceVersionType.V2}/`;
}
